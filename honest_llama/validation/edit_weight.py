...
MY_MODEL = "tum-nlp/gpt-2-medium-target-aware-counterspeech-generation" # specify model name here 
...
HF_NAMES = {
    ...
    "tum-nlp/gpt-2-medium-target-aware-counterspeech-generation": "tum-nlp/gpt-2-medium-target-aware-counterspeech-generation"
}
def main(): 
    ...
    df = pd.read_csv('../conan_merged.csv')
    ...
    # the below code will have to be edited for this - get_separated activations
    ...
    if args.use_center_of_mass:
        com_directions = get_com_directions(num_layers, num_heads, train_set_idxs, val_set_idxs, separated_head_wise_activations, separated_labels) # no issues
    else:
        com_directions = None
