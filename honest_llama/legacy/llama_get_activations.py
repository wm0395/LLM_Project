...
import sys
sys.path.append('../')
from utils import get_llama_activations_bau, tokenized_tqa, tokenized_tqa_gen, tokenized_tqa_gen_end_q, tokenized_conan
import llama
import pickle
import argparse
from transformers import AutoTokenizer, AutoModel, AutoModelForCausalLM

# get_llama_activations in utils will have to be checked 
...
def main(): 
    ...
    if args.dataset_name == "tqa_gen" or args.dataset_name == "tqa_gen_end_q" or args.dataset_name == "conan": 
